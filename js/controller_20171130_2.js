...
angular.module('Solicitudes', ['ngAnimate', 'ngSanitize', 'ui.bootstrap', 'angularFileUpload', 'darthwade.loading', 'ngTagsInput', 'ui.select', 'angular-js-xlsx', 'ui.mask'])
        ...
        .controller('ctrlLicitacion', ['$scope', '$http', '$uibModal', '$log', '$document', '$loading', 'FileUploader', function ($scope, $http, $uibModal, $log, $document, $loading, FileUploader) {
                 ...
                 $scope.AbrirModal = function(){
                    ...
                    $scope.erroresimportacion.push({fila: 1, campo:'Co20', error:'Valor NO numérico'});
                    $scope.erroresimportacion.push({fila: 2, campo:'Co20', error:'Valor NO numérico'});
                    if ($scope.erroresimportacion.length > 0){
                      $('#error-importacion').modal('show');
                      return 0;
                    }
                 }
                 ...
                 $scope.GetTemplate = function () {
                   console.log("pora qui");
                        $loading.start('myloading');
                       var URLTemplateParameter = '/GetTemplate'
               ...
               $scope.read = function (workbook) {
                 ...
                 angular.forEach(data.Bodegajes , function(bodegaje) {
                   ...
                   if(bodegaje.Submodalidad=="Aduanero"){
                         console.log("Tar ::: ", bodegaje.TarifaValor);
                         console.log("Minimo ::: ", bodegaje.TarifaMinima);
                         console.log("Otro ::: ", bodegaje.Otros);
